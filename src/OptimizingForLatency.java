/*
* This file can run in Android Studio IDE, not Intellij IDEA
* */
...
public class OptimizingForLatency {
    ...
    /*public static final String SOURCE_FILE = "./resources/test.png";
    public static final String DESTINATION_FILE = "./out/test.png";*/
